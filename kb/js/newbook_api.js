        ...
        .done(function( msg ) {
          ...
          // for문 (4개)
            ...
            for(var i=0; i<box.length; i++){
                  ...
                  $(".newbook_book1 > .box").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
        ...
        .done(function( msg ) {
          ...
          // for문 (4개)
            ...
            for(var i=0; i<box.length; i++){
                  ...
                  $(".newbook_book2 > .box").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
        ...
        .done(function( msg ) {
          ...
          // for문 (4개)
            ...
            for(var i=0; i<box.length; i++){
                  ...
                  $(".newbook_book3 > .box").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
        ...
        .done(function( msg ) {
          ...
          // for문 (4개)
            ...
            for(var i=0; i<box.length; i++){
                  ...
                  $(".newbook_book4 > .box").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
        ...
        .done(function( msg ) {
          ...
          // for문 (4개)
            ...
            for(var i=0; i<box.length; i++){
                  ...
                  $(".newbook_book5 > .box").eq(i).append("<img src='"+msg.documents[i].thumbnail+"'/>");
